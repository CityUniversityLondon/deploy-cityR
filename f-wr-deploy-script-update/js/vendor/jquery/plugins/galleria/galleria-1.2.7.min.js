(function($) {
    ...
    _video = {
      youtube: {
        ...
        getThumb: function(id, success, fail) {
          fail = fail || F;
          $.getJSON("http://gdata.youtube.com/feeds/api/videos/" + id + "?v=2&alt=json-in-script&callback=?", function(
            data
          ) {
            try {
      ...
      dailymotion: {
        ...
        getThumb: function(id, success, fail) {
          fail = fail || F;
          $.getJSON("https://api.dailymotion.com/video/" + id + "?fields=thumbnail_medium_url&callback=?", function(
            data
          ) {
            try {
    ...
    Utils = (function() {
      return {
        ...
        moveOut: function(elem) {
          Utils.forceStyles(elem, { position: "absolute", left: -10000 });
        },
        moveIn: function() {
    ...
    var carousel = (this._carousel = {
      ...
      animate: function(to) {
        ...
        Utils.animate(
          self.get("thumbnails"),
          { left: num },
          { duration: self._options.carouselSpeed, easing: self._options.easing, queue: false }
        );
      }
    });
    ...
    var idle = (this._idle = {
      ...
      hide: function() {
        ...
        $.each(idle.trunk, function(i, elem) {
          ...
          Utils.animate(elem, data.to, { duration: self._options.idleSpeed });
        });
      },
      showAll: function() {
        Utils.clearTimer(idle.timer);
      ...
      if (options.swipe) {
        (function(images) {
          var swipeStart = [0, 0],
            ...
            tid = 0,
            data,
            ev = { start: "touchstart", move: "touchmove", stop: "touchend" },
            getData = function(e) {
        ...
        if (o.thumbnails === true && (data.thumb || data.image)) {
          ...
          if (special.length == 2 && special[0] in _video) {
            thumb.load(
              ...
              { height: thumb.data.height, width: thumb.data.height * 1.25 },
              onThumbLoad
            );
          } else {
          ...
          if (data.iframe || optval === "empty" || optval === "numbers") {
      ...
      next.load(src, function(next) {
        ...
        self._scaleImage(next, {
          complete: function(next) {
            ...
            $.each({ initial: active.image === null, touch: Galleria.TOUCH, fullscreen: self.isFullscreen() }, function(
              type,
              arg
            ) {
  ...
  Galleria.raise = function(msg, fatal) {
    var type = fatal ? "Fatal error" : "Error",
      self = this,
      css = { color: "#fff", position: "absolute", top: 0, left: 0, zIndex: 100000 },
      echo = function(msg) {
        var html =
