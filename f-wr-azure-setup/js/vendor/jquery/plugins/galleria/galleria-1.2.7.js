        ...
        _video = {
            youtube: {
                ...
                getThumb: function(id, success, fail) {
                    fail = fail || F;
                    $.getJSON(
                        "http://gdata.youtube.com/feeds/api/videos/" + id + "?v=2&alt=json-in-script&callback=?",
                        function(data) {
                            try {
            ...
            dailymotion: {
                ...
                getThumb: function(id, success, fail) {
                    fail = fail || F;
                    $.getJSON(
                        "https://api.dailymotion.com/video/" + id + "?fields=thumbnail_medium_url&callback=?",
                        function(data) {
                            try {
            ...
            city: {
                ...
                embed: function(id) {
                    return "https://s1.city.ac.uk/js/flowplayer/embed.html?v=" + id;
                },
                getThumb: function(id, success, fail) {
                                ...
                                return function() {
                                    ...
                                    if (Galleria.WEBKIT && Galleria.TOUCH) {
                                        ...
                                        $.each(["left", "top"], function(i, m) {
                                            if (m in to) {
                                                form[i] =
                                                    Utils.parseValue(to[m]) - Utils.parseValue(elem.css(m)) + "px";
                                                revert[m] = to[m];
                                                delete to[m];
                                            }
                                        });
...
*/
    ...
    Galleria = function() {
        ...
        var carousel = (this._carousel = {
            ...
            follow: function(i) {
                ...
                while (
                    carousel.hooks[last] - carousel.hooks[carousel.current] < carousel.width &&
            ...
            init: function() {
                ...
                var elems = "overlay box content shadow title info close prevholder prev nextholder next counter image",
                    ...
                    cssMap = {
                        ...
                        content:
                            abs + "background-color:#fff;top:10px;left:10px;right:10px;bottom:10px;overflow:hidden",
                        info:
                            abs +
                ...
                Utils.wait({
                    ...
                    error: function() {
                        ...
                        if (testHeight()) {
                            ...
                            Galleria.raise(
                                "Could not extract a stage height from the CSS. Traced height: " + testHeight() + "px.",
                                true
                            );
                        }
                    },
    ...
    */
        ...
        trigger: function(type) {
            type =
                typeof type === "object" ? $.extend(type, { scope: this }) : { type: _patchEvent(type), scope: this };
